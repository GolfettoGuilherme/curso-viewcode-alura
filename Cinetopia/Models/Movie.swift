...
class Movie: Decodable {
    ...
    //quero ler o valor, mas não posso setar o valor, por isso o private(set)
    //opicional por causa do decode
    ...
    init(id: String, title: String, image: String, synopsis: String, rate: Double, releaseDate: String, isSelected: Bool? = nil) {
        self.id = id
        self.title = title
        self.image = image
